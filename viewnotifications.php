...
<body>
    <div class="container mt-5">
        ...
        <h4 class="text-center text-primary mb-4">THIS IS  REPORT ABOUT NOTIFICATIONS</h4>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='updatenotifications.php?NotificationID={$row['NotificationID']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deletenotifications.php?NotificationID={$row['NotificationID']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
