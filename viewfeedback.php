...
<body>
    <div class="container mt-5">
        ...
        <h4 class="text-center text-primary mb-4">THIS IS  REPORT ABOUT FEEDBACK</h4>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='updatefeedback.php?FeedbackID={$row['FeedbackID']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deletefeedback.php?FeedbackID={$row['FeedbackID']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
