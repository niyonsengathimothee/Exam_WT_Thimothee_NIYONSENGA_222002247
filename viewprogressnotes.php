...
<body>
    <div class="container mt-5">
        ...
        <h4 class="text-center text-primary mb-4">THIS IS  REPORT ABOUT PROGRESSNOTES</h4>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>{$row['NoteDate']}</td>
                        <td>
                            <a href='updateprogressnotes.php?NoteID={$row['NoteID']}'  class='btn btn-info'><i class='fas fa-edit'></i></a>
                            <a href='deleteprogressnotes.php?NoteID={$row['NoteID']}' class='btn btn-danger'><i class='fas fa-trash'></i></a>
                        </td>
                    </tr>
                    ";
                }
